          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                >
                  <span
                    className={`relative my-1.5 block h-0.5 w-[30px] bg-black transition-all duration-300 dark:bg-[#2C303B] ${
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                {!isLoggedIn && (
                  <>
                    ...
                    <Link
                      href="/signup"
                      className="bg-white text-primary border border-primary rounded-xs px-6 py-2 text-base font-semibold shadow-btn hover:bg-primary hover:text-white transition duration-300 md:inline-block hidden"
                    >
                      Sign Up
                    </Link>
                  </>
                ...
                {isLoggedIn && (
                  <button
                    ...
                    className="ml-4 text-base font-medium text-red-500 hover:underline bg-transparent border-none cursor-pointer"
                  >
                    Logout
                  </button>
                )}
