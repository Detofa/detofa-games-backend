...
const DetofaGamesPrivacyPolicy = () => (
  <section className="relative z-10 overflow-hidden pt-36 pb-16 md:pb-20 lg:pt-[180px] lg:pb-28">
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      <h1 className="text-3xl font-bold mb-6">
        Privacy Policy for Detofa games
      </h1>
      <p className="mb-4 font-semibold">Last updated: July 17, 2025</p>
      <p className="mb-4">
      ...
      <ul className="list-disc pl-6 mb-4">
        ...
        <li>
          <strong>Application</strong> refers to Detofa games, the software
          program provided by the Company.
        </li>
        <li>
          <strong>Company</strong> (referred to as either "the Company", "We",
          "Us" or "Our" in this Agreement) refers to Detofa entrepirse, 53
          AV.kisangani Q,kyeshero.
        </li>
        <li>
          <strong>Country</strong> refers to: Congo - Kinshasa
        </li>
        <li>
      ...
      <h3 className="text-xl font-bold mt-6 mb-2">Links to Other Websites</h3>
      <p className="mb-4">
      ...
      <ul className="list-disc pl-6 mb-4">
        <li>By email: info@detofaentreprise.com</li>
      </ul>
    </div>
  </section>
);
